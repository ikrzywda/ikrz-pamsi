...
int generate_message(uint8_t *message, const char *input_file_path, size_t message_length, int offset);

int init_driver_data(DriverData *driver_data, size_t message_length, size_t part_length, int message_offset);
